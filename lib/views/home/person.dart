          ...
          child: Row(children: <Widget>[
            Padding(
              ...
              child: CircleAvatar(
                ...
                backgroundImage:
                    (_profile.user.photo == null || _profile.user.photo == '')
            ...
            Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                      '角色:${Dictionary.getNameByUniqueNameAndCode(uniqueName: UniqueNameValues[UNIQUE_NAME.ORGTYPE], code: _profile.user.personType)}',
                      style: TextStyle(color: Colors.white))
                ])
          ])),
    );
