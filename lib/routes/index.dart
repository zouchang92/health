...
final routes = {
  ...
  '/searchStudent':(context,a,b)=>ContactList(argument: ModalRoute.of(context).settings.arguments),
  ...
  '/healthDetail':(context,a,b)=>HealthDetail(arg: ModalRoute.of(context).settings.arguments),
  '/healthCardReport':(context,a,b)=>HealthCardReport(args: ModalRoute.of(context).settings.arguments),
  ...
  '/leaveDateil':(context,a,b)=>LeaveDetail(arg:ModalRoute.of(context).settings.arguments),
  '/LeaveApplyForStudent':(context,a,b)=>LeaveApplyForStudent(args: ModalRoute.of(context).settings.arguments),
  '/newsList':(context,a,b)=>NewsList(),
  '/newsDetail':(context,a,b)=>NewsDetail(args: ModalRoute.of(context).settings.arguments)
};